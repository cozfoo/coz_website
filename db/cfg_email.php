...
//if ($order_by_fld != "disp_ord") { $order_by_fld  .= ",col,disp_ord"; },col,disp_ord
$show_table_sql = "SELECT email,lastname,firstname,status,ID FROM $tbl_name ORDER BY $order_by_fld";
